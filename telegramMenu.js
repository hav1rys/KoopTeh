...
function buildHelpView() {
  const text = [
    ...
    '/расписание (/raspisanie) — расписание на сегодня (или пришли «дд.мм»)',
    '/сейчас (/seychas) — текущая и следующая пара',
    '/поиск (/poisk) — кабинет / преподаватель / предмет / группа',
    '/преподаватель (/prepodavatel) — кто что ведёт, по фамилии',
    '/звонки (/zvonki) — расписание звонков',
